                        ...
                        <AnimatePresence>
                          {pageData.sections.map((section, index) => (
                            <motion.div 
                              ...
                              exit={{ opacity: 0, x: -10 }}
                              className={`group flex items-center gap-3 p-3 rounded-xl border transition-all cursor-pointer focus-within:ring-2 focus-within:ring-indigo-500 focus-within:outline-none ${activeSectionId === section.id ? 'bg-indigo-50 border-indigo-200 text-indigo-700' : 'bg-white border-slate-100 hover:border-slate-300 text-slate-600'}`}
