        ...
        {step === 'editor' && (
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-5 py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 transition-all shadow-md shadow-indigo-100 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-offset-2 focus-visible:outline-none"
            >
              <Save size={18} />
              Guardar
            </button>
                        ...
                        <AnimatePresence>
                          {pageData.sections.map((section) => (
                            <motion.div 
                              ...
                              exit={{ opacity: 0, x: -10 }}
                              className={`group flex items-center p-1 rounded-xl border transition-all ${activeSectionId === section.id ? 'bg-indigo-50 border-indigo-200' : 'bg-white border-slate-100 hover:border-slate-300'}`}
                            >
                              <button
                                onClick={() => setActiveSectionId(section.id)}
                                className={`flex-1 flex items-center gap-3 p-2 text-left rounded-lg transition-all focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:outline-none ${activeSectionId === section.id ? 'text-indigo-700' : 'text-slate-600'}`}
                              >
                              ...
                              <button 
                                ...
                                className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 p-1.5 hover:bg-red-50 hover:text-red-600 rounded-md transition-all focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none mr-1"
                              >
                                <Trash2 size={14} />
                              </button>
                            </motion.div>
